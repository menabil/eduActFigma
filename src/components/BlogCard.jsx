    ...
    <div className="bg-[#152B4A] lg:h-[488px] h-[400px] lg:w-[416px] rounded-[14px] relative group mb-20 w-[90%]">
      <div className="absolute lg:w-[357px] w-[300px] bg-white -bottom-20 left-1/2 -translate-x-1/2 shadow-newMade p-7 rounded-tl-[10px] rounded-tr-[10px] rounded-bl-[50px] rounded-br-[50px]">
        <Flex className={"justify-between"}>
          ...
          <p className="lg:text-base text-sm text-secondarys font-semibold">
            26 Mar, 2023
          </p>
        </Flex>
        <h5 className="py-6 lg:text-2xl text-xl text-primaryTwo font-bold">
        ...
        <Flex className={"justify-between"}>
          <div className="flex items-center">
            ...
            <div className="">
              <p className="text-base text-primaryTwo font-bold pb-1">
                Darrell Steward
              </p>
          ...
          <div className="w-10 h-10 rounded-full bg-transparent group-hover:bg-secondarys border border-secondarys text-[#697585] group-hover:text-white duration-300 relative">
